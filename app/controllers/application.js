...
const FEATURES = [
  ...
  },
  {
    ...
    "status": "RFC merged",
    "description": "Introduces a new set of module groupings and exposes them as importable ES2015 packages. </p><p> This also paves the way for automated tree-shaking - automatically stripping out framework and addon code never used by your app.",
    "rfc": {
      "id": 176,
  ...
  },
  {
    ...
    "status": "beta",
    "description": "Public API to fetch a factory for creating dependency-injected instances.",
    "rfc": {
      "id": 150,
  ...
  },
  {
    ...
    "status": "RFC merged",
    "description": "Create a unified pattern for organizing and naming modules in Ember projects that is deterministic, extensible, and ergonomic.",
    "rfc": {
      "id": 143,
  ...
  },
  {
    ...
    "status": "RFC merged",
    "description": "Introduce <code>Ember.String.isHtmlSafe()</code> to provide a reliable way to determine if an object is an \"html safe string\", i.e. was it created with <code>Ember.String.htmlSafe()</code>.",
    "rfc": {
      "id": 139,
  ...
  },
  {
    "name": "Router Service",
    "status": "RFC merged",
    "description": "Provices a public router service.",
    "rfc": {
      "id": 95,
...
export default Ember.Controller.extend({
  ...
  groupedFeatures: groupBy('features', 'status')
});
